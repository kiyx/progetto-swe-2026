...
public class DeleteMembroDialog extends JDialog
{
    ...
    public DeleteMembroDialog(Frame owner, java.util.List<UtenteResponseDTO> members)
    {
        super(owner, "Elimina Membri dal team", true);
        ...
        JButton btnConfirm = new JButton("Conferma Eliminazione");
